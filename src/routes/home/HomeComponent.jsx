...
const Home = () => {
  const categories = [
    ...
    },
    {
      "id": 2,
      "title": "jackets",
      "imageUrl": "https://images.unsplash.com/photo-1577660002965-04865592fc60?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8amFja2V0c3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=40"
    },
    {
      "id": 3,
      "title": "sneakers",
